...
int soBornShot(SCSHOT& shot)
{
  ...
  server_info.game.IncrementLOID();
  GAME_MAXOBJS_TYPE slot = server_info.game.FindUnusedSlot();
  server_info.game.RebornObject(server_info.game.last_oid, slot, ot_shot);
...
int soBornExtra(SCEXTRA& extra)
{
  ...
  server_info.game.IncrementLOID();
  GAME_MAXOBJS_TYPE slot = server_info.game.FindUnusedSlot();
  server_info.game.RebornObject(server_info.game.last_oid, slot, ot_extra);
...
int soBornBomb(SCBOMB& bomb)
{
  ...
  server_info.game.IncrementLOID();
  GAME_MAXOBJS_TYPE slot = server_info.game.FindUnusedSlot();
  server_info.game.RebornObject(server_info.game.last_oid, slot, ot_bomb);
...
int coBornPlayer(SCPLAYER& player)
{
  ...
  client_info.game.RebornObject(client_info.game.last_oid, slot, ot_player);
...
int coBornShot(SCSHOT& shot)
{
  ...
  client_info.game.IncrementLOID();
  GAME_MAXOBJS_TYPE slot = client_info.game.FindUnusedSlot();
  client_info.game.RebornObject(client_info.game.last_oid, slot, ot_shot);
...
int coBornExtra(SCEXTRA& extra)
{
  ...
  client_info.game.IncrementLOID();
  GAME_MAXOBJS_TYPE slot = client_info.game.FindUnusedSlot();
  client_info.game.RebornObject(client_info.game.last_oid, slot, ot_extra);
...
int coBornBomb(SCBOMB& bomb)
{
  ...
  client_info.game.IncrementLOID();
  GAME_MAXOBJS_TYPE slot = client_info.game.FindUnusedSlot();
  client_info.game.RebornObject(client_info.game.last_oid, slot, ot_bomb);
