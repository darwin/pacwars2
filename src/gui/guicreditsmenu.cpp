...
GUI_CreditsMenu::GUI_CreditsMenu() : GUI_BaseMenu(GUI_CREDITS, PG_Rect(CM_PX,CM_PY,CM_VX,CM_VY)) {
	...
	lLine[13] = new PG_Label(mBack1, PG_Rect(CM_G2_PX,CM_G2_PY+315, CM_G2_VX-2,20), "zlib, libpng, libjpeg, UPX packer", "GUI_LabelL");
	lLine[14] = new PG_Label(mBack1, PG_Rect(CM_G1_PX,CM_G1_PY+135, CM_G1_VX-2,20), "Linux port by Alexander Pipelka aka Braindead", "GUI_LabelL");
	...
	lLine[16] = new PG_Label(mBack1, PG_Rect(CM_G1_PX,CM_G1_PY+175, CM_G1_VX-2,20), "Iain Syme author of the orignal PacWars", "GUI_Label");
	lLine[18] = new PG_Label(mBack1, PG_Rect(4,345, CM_VX-2,25), "http://pw2.tsx.org", "GUI_LabelL");
