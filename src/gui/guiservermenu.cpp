...
GUI_ServerMenu::GUI_ServerMenu() : GUI_BaseMenu(GUI_SERVER, PG_Rect(SMS_PX,SMS_PY,SMS_VX,SMS_VY)) {
	...
	lEffect = new GUI_Label(this, PG_Rect(1,30,VM_VX-2,20), "This settings will affect the server side of the game.", false);
	ServerMenu = new GUI_Label(this, PG_Rect(1,4,SMS_VX-2,25), "SERVER OPTIONS", false);
	lServerName = new GUI_Label(this, PG_Rect(1,65, 119,20), "Server name:", false);
	eServerName = new GUI_TextEdit(this, PG_Rect(120,65,215,20));
	lWelcomeMsg = new GUI_Label(this, PG_Rect(1,90,119,20), "Welcome msg:", false);
	eWelcomeMsg = new GUI_TextEdit(this, PG_Rect(120,90,215,20));
	lMaxClients = new GUI_Label(this, PG_Rect(1,115,119,20), "Max clients:", false);
	eMaxClients = new GUI_NumEdit(this, PG_Rect(120,115,80,20), 1, PWP_TOTALMAX_CLIENTS);
	lTimelimit = new GUI_Label(this, PG_Rect(1,140, 119,20), "timelimit:", false);
	...
	lPassword = new GUI_Label(this, PG_Rect(1,265, 119,20), "Remote password:", false);
