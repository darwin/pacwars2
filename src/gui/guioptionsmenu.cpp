...
GUI_OptionsMenu::GUI_OptionsMenu() : GUI_BaseMenu(GUI_OPTIONS, PG_Rect(OM_PX,OM_PY,OM_VX,OM_VY)) {
	...
	bServer = new GUI_ButtonBig(this, 1, PG_Rect(0,40,OM_VX,40), "Server");
	bClient = new GUI_ButtonBig(this, 5, PG_Rect(0,80,OM_VX,40), "Client");
	bVideo = new GUI_ButtonBig(this, 2, PG_Rect(0,120,OM_VX,40), "Video");
	bSound = new GUI_ButtonBig(this, 3, PG_Rect(0,160,OM_VX,40), "Sound");
	bPaths = new GUI_ButtonBig(this, 4, PG_Rect(0,200,OM_VX,40), "Paths");
	bBack = new GUI_ButtonBig(this, 10, PG_Rect(0,240,OM_VX,40), "Back");
