...
{
  Cvar_Set("p1_keyn_weapon1", SDL_GetKeyName((SDLKey)atoi(var->string)));
}
void CL_p1_KeyChanged9(cvar_t* var, int* changed)
{
  Cvar_Set("p1_keyn_weapon2", SDL_GetKeyName((SDLKey)atoi(var->string)));
}
void CL_p1_KeyChanged10(cvar_t* var, int* changed)
{
  Cvar_Set("p1_keyn_weapon3", SDL_GetKeyName((SDLKey)atoi(var->string)));
}
void CL_p1_KeyChanged11(cvar_t* var, int* changed)
{
  Cvar_Set("p1_keyn_weapon4", SDL_GetKeyName((SDLKey)atoi(var->string)));
}
void CL_p1_KeyChanged12(cvar_t* var, int* changed)
{
  Cvar_Set("p1_keyn_weapon5", SDL_GetKeyName((SDLKey)atoi(var->string)));
}
...
cvar_t	p1_key_up = {"p1_key_up", "", true, false, CL_p1_KeyChanged1, STD_KEY_UP};
cvar_t	p1_key_down = {"p1_key_down", "", true, false, CL_p1_KeyChanged2, STD_KEY_DOWN};
cvar_t	p1_key_left = {"p1_key_left", "", true, false, CL_p1_KeyChanged3, STD_KEY_LEFT};
cvar_t	p1_key_right = {"p1_key_right", "", true, false, CL_p1_KeyChanged4, STD_KEY_RIGHT};
cvar_t	p1_key_fire = {"p1_key_fire", "", true, false, CL_p1_KeyChanged5, STD_KEY_FIRE};
cvar_t	p1_key_shield = {"p1_key_shield", "", true, false, CL_p1_KeyChanged6, STD_KEY_SHIELD};
cvar_t	p1_key_warp = {"p1_key_warp", "", true, false, CL_p1_KeyChanged7, STD_KEY_WARP};
cvar_t	p1_key_weapon1 = {"p1_key_weapon1", "", true, false, CL_p1_KeyChanged8, STD_KEY_WEAPON1};
cvar_t	p1_key_weapon2 = {"p1_key_weapon2", "", true, false, CL_p1_KeyChanged9, STD_KEY_WEAPON2};
cvar_t	p1_key_weapon3 = {"p1_key_weapon3", "", true, false, CL_p1_KeyChanged10, STD_KEY_WEAPON3};
cvar_t	p1_key_weapon4 = {"p1_key_weapon4", "", true, false, CL_p1_KeyChanged11, STD_KEY_WEAPON4};
cvar_t	p1_key_weapon5 = {"p1_key_weapon5", "", true, false, CL_p1_KeyChanged12, STD_KEY_WEAPON5};
...
{
  Cvar_Set("p2_keyn_weapon1", SDL_GetKeyName((SDLKey)atoi(var->string)));
}
void CL_p2_KeyChanged9(cvar_t* var, int* changed)
{
  Cvar_Set("p2_keyn_weapon2", SDL_GetKeyName((SDLKey)atoi(var->string)));
}
void CL_p2_KeyChanged10(cvar_t* var, int* changed)
{
  Cvar_Set("p2_keyn_weapon3", SDL_GetKeyName((SDLKey)atoi(var->string)));
}
void CL_p2_KeyChanged11(cvar_t* var, int* changed)
{
  Cvar_Set("p2_keyn_weapon4", SDL_GetKeyName((SDLKey)atoi(var->string)));
}
void CL_p2_KeyChanged12(cvar_t* var, int* changed)
{
  Cvar_Set("p2_keyn_weapon5", SDL_GetKeyName((SDLKey)atoi(var->string)));
}
...
cvar_t	p2_key_up = {"p2_key_up", "", true, false, CL_p2_KeyChanged1, STD_KEY_UP};
cvar_t	p2_key_down = {"p2_key_down", "", true, false, CL_p2_KeyChanged2, STD_KEY_DOWN};
cvar_t	p2_key_left = {"p2_key_left", "", true, false, CL_p2_KeyChanged3, STD_KEY_LEFT};
cvar_t	p2_key_right = {"p2_key_right", "", true, false, CL_p2_KeyChanged4, STD_KEY_RIGHT};
cvar_t	p2_key_fire = {"p2_key_fire", "", true, false, CL_p2_KeyChanged5, STD_KEY_FIRE};
cvar_t	p2_key_shield = {"p2_key_shield", "", true, false, CL_p2_KeyChanged6, STD_KEY_SHIELD};
cvar_t	p2_key_warp = {"p2_key_warp", "", true, false, CL_p2_KeyChanged7, STD_KEY_WARP};
cvar_t	p2_key_weapon1 = {"p2_key_weapon1", "", true, false, CL_p2_KeyChanged8, STD_KEY_WEAPON1};
cvar_t	p2_key_weapon2 = {"p2_key_weapon2", "", true, false, CL_p2_KeyChanged9, STD_KEY_WEAPON2};
cvar_t	p2_key_weapon3 = {"p2_key_weapon3", "", true, false, CL_p2_KeyChanged10, STD_KEY_WEAPON3};
cvar_t	p2_key_weapon4 = {"p2_key_weapon4", "", true, false, CL_p2_KeyChanged11, STD_KEY_WEAPON4};
cvar_t	p2_key_weapon5 = {"p2_key_weapon5", "", true, false, CL_p2_KeyChanged12, STD_KEY_WEAPON5};
...
{
  Cvar_Set("p3_keyn_weapon1", SDL_GetKeyName((SDLKey)atoi(var->string)));
}
void CL_p3_KeyChanged9(cvar_t* var, int* changed)
{
  Cvar_Set("p3_keyn_weapon2", SDL_GetKeyName((SDLKey)atoi(var->string)));
}
void CL_p3_KeyChanged10(cvar_t* var, int* changed)
{
  Cvar_Set("p3_keyn_weapon3", SDL_GetKeyName((SDLKey)atoi(var->string)));
}
void CL_p3_KeyChanged11(cvar_t* var, int* changed)
{
  Cvar_Set("p3_keyn_weapon4", SDL_GetKeyName((SDLKey)atoi(var->string)));
}
void CL_p3_KeyChanged12(cvar_t* var, int* changed)
{
  Cvar_Set("p3_keyn_weapon5", SDL_GetKeyName((SDLKey)atoi(var->string)));
}
...
cvar_t	p3_key_up = {"p3_key_up", "", true, false, CL_p3_KeyChanged1, STD_KEY_UP};
cvar_t	p3_key_down = {"p3_key_down", "", true, false, CL_p3_KeyChanged2, STD_KEY_DOWN};
cvar_t	p3_key_left = {"p3_key_left", "", true, false, CL_p3_KeyChanged3, STD_KEY_LEFT};
cvar_t	p3_key_right = {"p3_key_right", "", true, false, CL_p3_KeyChanged4, STD_KEY_RIGHT};
cvar_t	p3_key_fire = {"p3_key_fire", "", true, false, CL_p3_KeyChanged5, STD_KEY_FIRE};
cvar_t	p3_key_shield = {"p3_key_shield", "", true, false, CL_p3_KeyChanged6, STD_KEY_SHIELD};
cvar_t	p3_key_warp = {"p3_key_warp", "", true, false, CL_p3_KeyChanged7, STD_KEY_WARP};
cvar_t	p3_key_weapon1 = {"p3_key_weapon1", "", true, false, CL_p3_KeyChanged8, STD_KEY_WEAPON1};
cvar_t	p3_key_weapon2 = {"p3_key_weapon2", "", true, false, CL_p3_KeyChanged9, STD_KEY_WEAPON2};
cvar_t	p3_key_weapon3 = {"p3_key_weapon3", "", true, false, CL_p3_KeyChanged10, STD_KEY_WEAPON3};
cvar_t	p3_key_weapon4 = {"p3_key_weapon4", "", true, false, CL_p3_KeyChanged11, STD_KEY_WEAPON4};
cvar_t	p3_key_weapon5 = {"p3_key_weapon5", "", true, false, CL_p3_KeyChanged12, STD_KEY_WEAPON5};
...
{
  Cvar_Set("p4_keyn_weapon1", SDL_GetKeyName((SDLKey)atoi(var->string)));
}
void CL_p4_KeyChanged9(cvar_t* var, int* changed)
{
  Cvar_Set("p4_keyn_weapon2", SDL_GetKeyName((SDLKey)atoi(var->string)));
}
void CL_p4_KeyChanged10(cvar_t* var, int* changed)
{
  Cvar_Set("p4_keyn_weapon3", SDL_GetKeyName((SDLKey)atoi(var->string)));
}
void CL_p4_KeyChanged11(cvar_t* var, int* changed)
{
  Cvar_Set("p4_keyn_weapon4", SDL_GetKeyName((SDLKey)atoi(var->string)));
}
void CL_p4_KeyChanged12(cvar_t* var, int* changed)
{
  Cvar_Set("p4_keyn_weapon5", SDL_GetKeyName((SDLKey)atoi(var->string)));
}
...
cvar_t	p4_key_up = {"p4_key_up", "", true, false, CL_p4_KeyChanged1, STD_KEY_UP};
cvar_t	p4_key_down = {"p4_key_down", "", true, false, CL_p4_KeyChanged2, STD_KEY_DOWN};
cvar_t	p4_key_left = {"p4_key_left", "", true, false, CL_p4_KeyChanged3, STD_KEY_LEFT};
cvar_t	p4_key_right = {"p4_key_right", "", true, false, CL_p4_KeyChanged4, STD_KEY_RIGHT};
cvar_t	p4_key_fire = {"p4_key_fire", "", true, false, CL_p4_KeyChanged5, STD_KEY_FIRE};
cvar_t	p4_key_shield = {"p4_key_shield", "", true, false, CL_p4_KeyChanged6, STD_KEY_SHIELD};
cvar_t	p4_key_warp = {"p4_key_warp", "", true, false, CL_p4_KeyChanged7, STD_KEY_WARP};
cvar_t	p4_key_weapon1 = {"p4_key_weapon1", "", true, false, CL_p4_KeyChanged8, STD_KEY_WEAPON1};
cvar_t	p4_key_weapon2 = {"p4_key_weapon2", "", true, false, CL_p4_KeyChanged9, STD_KEY_WEAPON2};
cvar_t	p4_key_weapon3 = {"p4_key_weapon3", "", true, false, CL_p4_KeyChanged10, STD_KEY_WEAPON3};
cvar_t	p4_key_weapon4 = {"p4_key_weapon4", "", true, false, CL_p4_KeyChanged11, STD_KEY_WEAPON4};
cvar_t	p4_key_weapon5 = {"p4_key_weapon5", "", true, false, CL_p4_KeyChanged12, STD_KEY_WEAPON5};
...
{
  for (int i=0; i<PWP_MAX_PLAYERS_PER_CLIENT; i++) keybindings[i].used = false;
}

int CL_FindUnusedKBSlot()
{
  int i=0;
  for (i=0; i<PWP_MAX_PLAYERS_PER_CLIENT; i++) if (!keybindings[i].used) break;
  if (i==PWP_MAX_PLAYERS_PER_CLIENT) 
  {
    ConOut("All keybinding slots are in use - using slot 0");
    return 0;
  }
  return i;
}
...
void net_client_info::AddDlRequest(Uint8 id, char* fname)
{
  if (net_client_status == NS_CONNECTED) 
  {
    ...
    while (*i) 
    {
      if ((**i).id==id && strcmp((**i).filename,fname)==0) return;
      i=&(*i)->next;
    }
    *i = fr;

    ConOut("Added request for downloading %s", fname);
...
void net_client_info::ScheduleNewDlRequest()
{
  ...
  if (dlreqs)
  {
    ConOut("Asking for downloading %s", dlreqs->filename);
    CL_Download(dlreqs->id, dlreqs->filename);
  }
...
int CL_ClearFileTransfer(int how)
{
  ...
  case FT_FINISHED_RENAME:
    ...
    {
      ConOut("Client: error renaming received file !");
    }
    break;
  case FT_FINISHED:
    if (server.file)
  ...
  case FT_ABANDONED:
    if (server.file)
    {
      ...
      if (c_deletetmps.value)
      {
        ...
        if (remove(tmp)!=0)
        {
          ConOut("Client: error removing broken tmp file !");
        }
      }
    }
    break;
...
int CL_Start(char * station_name)
{
  ...
  server.status = SS_UNUSED;
  server.file_sock = NULL;
  if (CreatePool(&server.msg_pool, MSG_SPOOL_SIZE, MSG_RPOOL_SIZE, PWP_MMP_SIZE))
  {
    SDLNet_SetError("Couldn't create msg pool (client): Out of memory\n");
    return 1;
  }
  if (CreatePool(&server.game_pool, GAME_SPOOL_SIZE, GAME_RPOOL_SIZE, PWP_MGP_SIZE))
  {
    SDLNet_SetError("Couldn't create game pool (client): Out of memory\n");
    return 1;
  }
  server.buffer = (Uint8*)malloc(PWP_FBUFFER_SIZE);
  if (!server.buffer)
  {
    SDLNet_SetError("Couldn't create file buffer (client): Out of memory\n");
    return 1;
  }
  ...
  if (!server.quantum)
  {
    SDLNet_SetError("Couldn't create quantum buffer (client): Out of memory\n");
    return 1;
  }
  ...
  for (i=0; (msg_csock == NULL || game_csock == NULL) && i<PWP_PORT_STEP*PWP_SOCKET_RANGE; i+=PWP_PORT_STEP ) {
...
int CL_End()
{
  if (net_client_status == NS_UNINITED) return 0;
...
int HandleClientMessage()
{
  ...
  while ( n-- > 0 ) 
  {
    len = MSG.Receive(&server.msg_pool, &server.stats, msg_csock, 0, msg_cpackets[n], true);
    ...
    if ( msg_cpackets[n]->channel >= 0 ) 
    {
      ...
      case MSGID_CHATWRITE: 
        ...
        ConOut((char*)&MSG.buf[POS_MSG_TEXT]);
        SetMessenger((char*)&MSG.buf[POS_MSG_TEXT]);
        break;
        
      case MSGID_REMOTECON: 
        switch (MSG.buf[POS_MSG_CONTYPE]) {
        case 0: ConOut("$%s", &MSG.buf[POS_MSG_CON]); break;
        case 1: ConPar("$%s", &MSG.buf[POS_MSG_CON]); break;
        case 2: ConPut(1, "$%s", &MSG.buf[POS_MSG_CON]); break;
        }
        break;
        
        case MSGID_CHMAP: 
          CL_ChangeMap((char*)&MSG.buf[POS_MSG_MAPNAME], (char*)&MSG.buf[POS_MSG_SCRIPTNAME]);
          break;
        ...
        case MSGID_SERVERFULL: 
          ...
          {
            ConOut("Client: rejected - server is full");
            CL_Clear();
          }
          else
            fprintf(stderr, "%d>Client: unexpected SERVERFULL message from %s", client_info.ticks, AddrToS(&msg_cpackets[n]->address));
          break;
        case MSGID_YWDROPPED: 
          if (net_client_status==NS_CONNECTED)
          {
            ConOut("Client: you were dropped.");
            CL_Clear();
          }
          else
            fprintf(stderr, "%d>Client: unexpected YWDROPPED message from %s", client_info.ticks, AddrToS(&msg_cpackets[n]->address));
          break;
        case MSGID_KBNOTIFY: 
          if (net_client_status==NS_CONNECTED)
          {
            ...
            fprintf(stderr, "%d>Client: unexpected KBNOTIFY message from %s", client_info.ticks, AddrToS(&msg_cpackets[n]->address));
          break;
        ...
        case MSGID_SERVEROFF: 
          if (net_client_status==NS_INITED)
          {
            ConOut("Client: rejected - server is not running");
            CL_Clear();
          }
          else
            fprintf(stderr, "%d>Client: unexpected SERVEROFF message from %s", client_info.ticks, AddrToS(&msg_cpackets[n]->address));
          break;
        case MSGID_WELCOME: 
          if (net_client_status==NS_INITED)
          {
            ...
            ConOut("Welcome to %s", (char*)&MSG.buf[POS_MSG_WSNAME]);
            ConOut("Server version: %d.%02d", major, minor);
            ConOut("Server message: %s", (char*)&MSG.buf[POS_MSG_WSMSG]);
            if (major>VERSION_MAJOR || (major==VERSION_MAJOR && minor>VERSION_MINOR))
            {
              ConOut("Server version %d.%02d is greater than version of your program %d.%02d.\n");
              ConOut("Please download latest version of PacWars2. (%s)\n", PW_WEBADDRESS);
            }
            else
            {
        ...
        case MSGID_SERVERDOWN: 
          if (net_client_status==NS_CONNECTED)
          {
            ...
            case SD_SHUTDOWN:
            case SD_OFFLINE:
              ConOut("Client: server is down");
              net_client_status=NS_INITED;
              client_info.active = false;
              CL_Clear();
              break;
            case SD_CHANGING_GAME:
              ConOut("Client: game ended");
              net_client_status=NS_VIEWING_RESULTS;
              break;
            }
          }
          else
            fprintf(stderr, "%d>Client: unexpected SERVERDOWN message from %s", client_info.ticks, AddrToS(&msg_cpackets[n]->address));
        ...
        case MSGID_SNAME: 
          if (net_client_status==NS_CONNECTED)
          {
            ...
            ConOut("Server name changed to \"%s\"", server.name);
          }
          break;
          
        default:
          fprintf(stderr, "%d>Client: Unresolved message packet (client) ID=%d from %s!\n", client_info.ticks, msg_cpackets[n]->data[POS_MSG_ID], AddrToS(&msg_cpackets[n]->address));
      }
    }
    else //we've got unbound message
    {
      fprintf(stderr, "%d>Client: Unresolved unbound message packet (client) ID=%d from %s!\n", client_info.ticks, msg_cpackets[n]->data[POS_MSG_ID], AddrToS(&msg_cpackets[n]->address));
    }
  }
...
int CL_Connect(char* server)
{
  ...
  if (net_client_status!=NS_UNINITED)
  {
    ...
    else 
    {
	  ...
	  if (remote_host_name)
		ConOut("Connecting to %s [%s]", /*_strlwr(*/remote_host_name/*)*/, AddrToS(&msg_serverIP));
	  else
		ConOut("Connecting to [%s]", AddrToS(&msg_serverIP));
...
int ChatMessage(char* m)
{
  ...
  MSG.Send(&server.msg_pool, &server.stats, msg_csock, 0, true, RESEND_CHAT);
...
void CL_Ping()
{
  if ((net_client_status==NS_CONNECTED) && pingreturned)
  {
    ...
    MSG << MSGID_PING;
    MSG.Send(&server.msg_pool, &server.stats, msg_csock, 0, true, RESEND_PING, PingReturn);
...
void AttachNotify(net_message *msg)
{
  ConOut("Server console attached");
}
...
int CL_Attach()
{
  if (!client_info.con_attach)
  {
    ...
    MSG << MSGID_ATTACHCON;
    MSG.Send(&server.msg_pool, &server.stats, msg_csock, 0, true, RESEND_SYSTEM, AttachNotify);
    client_info.con_attach = 1;
  }
  else
    ConOut("Server console allready attached");
  return 0;
}

void DetachNotify(net_message *msg)
{
  ConOut("Server console detached");
}
...
int CL_Detach()
{
  if (client_info.con_attach)
  {
    ...
    MSG << MSGID_DETACHCON;
    MSG.Send(&server.msg_pool, &server.stats, msg_csock, 0, true, RESEND_SYSTEM, DetachNotify);
    client_info.con_attach = 0;
  }
  else
    ConOut("Server console isn't attached");
...
int HandleFileResponse()
{
  ...
  if ((server.file_status!=FS_WAIT_RECEIVING) && (server.file_status!=FS_WAIT_SENDING))
  {
    fprintf(stderr, "%d>unexpected file transfer response !!", client_info.ticks);
    return 1;
  }
  ...
  { // RECEIVING = DOWNLOADING from server
    
    // check if file exists
    server.file = fopen(server.local_fn, "rb");
    if (server.file)
    {
      ConOut("Client: local file %s exists\n", server.local_fn);
    ...
    if (!server.file)
    {
      ConOut("Client: couldn't open local file for writing");
      CL_ClearFileTransfer(FT_ABANDONED);
      return 1;
    }
  ...
  { // SENDING = UPLOADING to server
    ...
    if (!server.file)
    {
      ConOut("Client: local file doesn't exist");
      CL_ClearFileTransfer(FT_ABANDONED);
      return 1;
    }
  ...
  if (net_client_status!=NS_UNINITED)
  {
    ...
    if (net_client_status==NS_CONNECTED)
    {
      if (server.status!=SS_UNUSED)
      {
        ...
        if (!pingreturned && ((time - pingsent)>=(Uint32)net_ping_timeout.value))
        {
          CL_ServerCrashed();
        }
        
        // manage file transfers
        if ((server.file_status==FS_SENDING) || (server.file_status==FS_RECEIVING)) 
        {
          if (server.file_status==FS_SENDING)
          { // SENDING
            count = LoadFileBuffer(&server.zs, server.quantum, server.qsize, 
              server.buffer, server.bsize, server.file, 
              &server.file_status);
            if (count)
            {
              transfered = SDLNet_TCP_Send(server.file_sock, (char*)server.quantum, count);
              if (transfered<count)
              {
            ...
            if ((server.file_status==FS_ENDED) || (server.file_status==FS_COMPLETED))
            {
              if (server.file_status==FS_COMPLETED)
                ConOut("Client: File transfer done (%d/%d)", server.zs.total_out, server.zs.total_in);
          ...
          { // RECEIVING
            ...
            {
              count = SDLNet_TCP_Recv(server.file_sock, (char*)server.quantum, server.qsize);
              if (count<=0)
              {
              ...
              {
                StoreFileBuffer(&server.zs, server.quantum, count, 
                  server.buffer, server.bsize, server.file, 
                  &server.file_status);
            ...
            // check for timeouts
            if ((SDL_GetTicks() - lcreCL_time) >= net_file_timeout.value)
            {
              ConOut("Client: File transfer timed out !");
              CL_ClearFileTransfer(FT_ABANDONED);
            }
            ...
            {
              if (server.file_status==FS_COMPLETED)
                ConOut("Client: File transfer done (%d/%d)", server.zs.total_in, server.zs.total_out);
...
int CL_Upload(Uint8 ft_id, char* fname)
{
  ...
  {
    ConOut("Client: uploading is not enabled, set \"c_uploading\" variable to 1");
    return 3;
  }
  ...
  {  
    ...
    {
      ConOut("Filename must be simple <filename.ext>");
      return 2;
    }
...
int CL_Download(Uint8 ft_id, char* fname)
{
  ...
  {
    ConOut("Client: downloading is not enabled, set \"c_downloading\" variable to 1");
    return 3;
  }
  ...
  {  
    if (!CheckFileName(fname)) 
    {
      ConOut("Client: filename must be simple <filename.ext>");
      return 2;
    }
...
void CL_EnterGame(Uint32 time)
{
  ...
  while (ctime>FRAMETICKS)
  {
    ...
    ctime-=FRAMETICKS;
    client_info.pticks--;
    if (client_info.pticks==0) client_info.pticks = PWP_TICKS_PER_PACKET_CLIENT;
  }
...
int CL_ChangeMap(char* mapname, char* scriptname)
{
  ...
  if (MapLoaded==0)
  {
    if (res!=-10)
    {
      ConOut("Client: map %s not found !", mapname);
      //ConOut("Ask for downloading map by typing \"dlmap %s\" in console", mapname);
    ...
    {
      ConOut("Client: script %s not found or not correct !", scriptname);
      //ConOut("Ask for downloading script by typing \"dlscript %s\" in console", scriptname);
...
GOT_REPCODE_IN_REPLICATION_CYCLE:
    ...
    case REP_ADJUSTPOSITION: 
      ...
      if (obj->GetType()!=ot_player) 
        fprintf(stderr, "%d>Client: error CL_ParseReplication ADJUSTPOSITION called for non-player object slot=%d\n", client_info.ticks, slot);
      else
      {
        player = (GPlayer*)obj;
    ...
    case REP_REPLICATION: 
      ...
      obj = game.objs[slot];
      if (obj->GetType()!=ot)
        fprintf(stderr, "%d>Client: error CL_ParseReplication REP_REPLICATION: nonconsistent object types %d", client_info.ticks, ot);
    ...
    case REP_SERVERMOVE: 
      fprintf(stderr, "%d>Client: error CL_ParseReplication forbiden rep_code=%d\n", client_info.ticks, rep_code);
      break;
      
    default: 
      fprintf(stderr, "%d>Client: error CL_ParseReplication unknown rep_code=%d\n", client_info.ticks, rep_code);
    }
  }  
  return 1;
}
...
int HandleClientGame(Uint32 deltaticks)
{
  ...
  while ( n-- > 0 ) 
  {
    len = GMP.Receive(&server.game_pool, &server.stats, game_csock, 0, game_cpackets[n], false);
    if (len<=0) continue;  // bad or confirming packet
    ...
    {
      if (!CL_ParseReplication(&GMP, incoming_tick, client_info.game, client_info.client_num))
      {
        fprintf(stderr, "%d>Client: error parsing server replication - incomingtick=%d !\n", client_info.ticks, incoming_tick);
        continue;
      }
    }
    //    else 
...
{
  Uint32 delta = ticktime - client_info.start_time - client_info.last_time;
  Uint8 buffer[MSG_MAX_BODY_SIZE];
  net_msg GP(buffer);

  if (pingreturned && ticktime-pingsent>=PING_MEASURE) CL_Ping();
...
int CL_ChasePlayerConf(int i)
{
  if ((client_info.game.objs[i]->state&OSTATE_ACTIVE) && (client_info.game.objs[i]->GetType()==ot_player))
  {
    ...
    ConOut("Chasing player \"%s\"", ((GPlayer*)client_info.game.objs[i])->player_name.GetValRef()->chars);
  }
  else
  {
...
int CL_ChasePlayer(char* name)
{
  ...
  for (i=0; i<GAME_MAX_OBJS; i++) 
  {
    ...
    {
      p = (GPlayer*)g.objs[i]; 
      if (strcmp(p->player_name.GetValRef()->chars, name)==0) break;
    }
  }
  ...
  {
    ConOut("Player \"%s\" not found", name);
  }
